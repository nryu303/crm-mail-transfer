...
CREATE TABLE IF NOT EXISTS DIFF_DEFINITION (
  ...
  MEMO_SLOT     INT          NOT NULL COMMENT 'which CRM_USER memo slot (1..10) this diff activates',
  DISPLAY_ORDER INT          DEFAULT 0,
  CREATED_AT    DATETIME     NOT NULL,
  UPDATED_AT    DATETIME     NOT NULL,
...
CREATE TABLE IF NOT EXISTS DIFF_SCHEDULE (
  ...
  MEMO_SLOT_SNAPSHOT      INT          NOT NULL,
  ...
  OFFSET_MODE             VARCHAR(16)  NOT NULL COMMENT 'MINUTES (当日) | DAYS (翌日以降+時刻)',
  ...
  SET_AT                  DATETIME     NOT NULL COMMENT 'セット時刻 — the moment the schedule was registered; offsets are relative to this',
  SCHEDULED_FOR           DATETIME     NOT NULL COMMENT 'computed absolute fire datetime',
  ...
  CREATED_AT              DATETIME     NOT NULL,
  UPDATED_AT              DATETIME     NOT NULL,
  KEY IDX_DIFF_SCHEDULE_STATUS_FOR (STATUS, SCHEDULED_FOR),
  KEY IDX_DIFF_SCHEDULE_TARGET (TARGET_TYPE, TARGET_VALUE),
